...
const WatchPage = ({ infoAllProduct, getAllProduct }) => {
  ...
  return (
    <Container>
        <h3>Quan ly dong ho thoi trang va dong ho thong minh :</h3>
...
export default connect(mapStateToProps, { getAllProduct })(WatchPage);
